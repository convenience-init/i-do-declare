...
public extension UIView {
	...
	var withYellowHighlight: Self {
		with {
			$0.layer.borderWidth = 1
			$0.layer.cornerRadius = 2
			$0.layer.borderColor = UIColor.systemYellow.withAlphaComponent(0.6 * 0.5).cgColor
			$0.backgroundColor = UIColor.systemYellow.withAlphaComponent(0.2 * 0.5)
		}
	}
	...
	var withRedLines: Self {
		with {
			$0.layer.borderWidth = 1
			$0.layer.cornerRadius = 2
			$0.layer.borderColor = UIColor.systemRed.withAlphaComponent(0.6 * 0.5).cgColor
			$0.backgroundColor = UIColor.systemRed.withAlphaComponent(0.2 * 0.5)
		}
	}
